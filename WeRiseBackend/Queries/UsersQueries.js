...
const createUser = async (req, res) => {
  try {
    ...
    // } = req.body
    let newUser = await database.one('INSERT INTO users(id, email, firstName, lastName, user_pic, bio) VALUES (${id}, ${email}, ${firstName}, ${lastName}, ${user_pic}, ${bio}) RETURNING *', req.body);
    res.status(200).json({
      status: "success",
